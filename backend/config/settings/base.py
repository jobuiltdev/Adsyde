...
GENERATION_PROVIDER = env("GENERATION_PROVIDER", "mock")
GENERATION_ENABLED_PROVIDERS = frozenset(env_list("GENERATION_ENABLED_PROVIDERS", "mock"))
GENERATION_MAX_RESULT_BYTES = int(env("GENERATION_MAX_RESULT_BYTES", "104857600"))
GENERATION_ALLOWED_RESULT_MIME_TYPES = frozenset(
    env_list("GENERATION_ALLOWED_RESULT_MIME_TYPES", "video/mp4")
)
PROVIDER_SUBMISSION_TIMEOUT_SECONDS = int(env("PROVIDER_SUBMISSION_TIMEOUT_SECONDS", "30"))
PROVIDER_STATUS_TIMEOUT_SECONDS = int(env("PROVIDER_STATUS_TIMEOUT_SECONDS", "15"))
PROVIDER_CANCELLATION_TIMEOUT_SECONDS = int(env("PROVIDER_CANCELLATION_TIMEOUT_SECONDS", "15"))
PROVIDER_RESULT_FETCH_TIMEOUT_SECONDS = int(env("PROVIDER_RESULT_FETCH_TIMEOUT_SECONDS", "60"))
